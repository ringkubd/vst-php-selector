...
1) <h3>cgi</h3>
```bash
wget https://raw.githubusercontent.com/ringkubd/vst-php-selector/main/vst-php-cgi.sh 
...
2) <h3>fcgi</h3>
```bash
wget https://raw.githubusercontent.com/ringkubd/vst-php-selector/main/vst-php-fcgid.sh 
...
3) <h3>fpm</h3>
```bash
wget https://raw.githubusercontent.com/ringkubd/vst-php-selector/main/vst-php-fpm.sh 
